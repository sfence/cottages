	...
	if listname == "fuel" then
		if minetest.get_craft_result({method="fuel", width=1, items={stack}}).time ~= 0 then
			if inv:is_empty("src") then
				meta:set_string("infotext", "Fireplace is empty")
			end
...
local function furnace_node_timer(pos, elapsed)
	...
	local infotext = "Fireplace " .. active .. "(Item: " .. item_state .. "; Fuel: " .. fuel_state .. ")"
...
minetest.register_node("hades_cottages:furnace", {
	...
	tiles = {
		...
		"cottages_furnace_side.png", "cottages_furnace_side.png",
		"cottages_furnace_side.png", "cottages_furnace_front.png"
	},
	paramtype2 = "facedir",
	groups = {cracky=2},
...
minetest.register_node("hades_cottages:furnace_active", {
	...
	tiles = {
		"cottages_furnace_top.png",  "cottages_furnace_bottom.png",
		"cottages_furnace_side.png", "cottages_furnace_side.png",
		"cottages_furnace_side.png",
		{
			image = "cottages_furnace_front_active.png",
...
minetest.register_craft({
	...
	recipe = {
			...
			{ cottages.craftitem_stone,  cottages.craftitem_stone,  cottages.craftitem_stone },
	},
})
